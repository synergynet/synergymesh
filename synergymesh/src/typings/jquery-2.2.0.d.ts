...
interface JQueryStatic {
    ...
    expr: any;
    fn: any;  //Should Decide how we want to type this
...
interface JQuery {
    ...
    /**
     * Get the current coordinates of the first element in the set of matched elements, relative to the offset parentProcessor.
     */
    ...
    /**
     * Get the parentProcessor of each element in the current set of matched elements, optionally filtered by a selector.
     *
     * @param selector A string containing a selector expression to match elements against.
     */
